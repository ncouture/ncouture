#+TITLE: Nicolas Couture
#+AUTHOR: Nicolas Couture
#+EMAIL: "Nicolas Couture" <work@stormvault.net>
#+OPTIONS: toc:nil
#+language:    en
#+startup:     hidestars
...
#+description: Nicolas Couture: Seasoned IT professional with over 20 years of experience in on-premises and hybrid cloud environments, contributed to developing and streamlining DevOps practices in the enterprise. Specialized in UNIX-like OSes, system administration, infrastructure automation, configuration management, and security. Proven ability to design, implement, and automate cloud solutions for improved efficiency, security, and scalability. Eager to leverage expertise in Azure, Google Cloud, OCI, and AWS to contribute to innovative cloud initiatives.
...
- [[https://www.linkedin.com/in/nicolascouture][LinkedIn]]
- [[https://github.com/ncouture][Github]]
- Calendar: [[https://calendar.app.google/WjxXaKGdbnXUkaf8A][Book me online]]
